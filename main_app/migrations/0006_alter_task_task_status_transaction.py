...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('main_app', '0005_rename_family_group_task_familygroups_and_more'),
    ]
    ...
    operations = [
        migrations.AlterField(
            model_name='task',
            name='task_status',
            field=models.CharField(choices=[('Completed', 'complete'), ('Incomplete', 'incomplete'), ('Not yet started', 'not yet started')], max_length=20),
        ),
