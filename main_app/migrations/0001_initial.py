# Generated by Django 4.0.3 on 2022-04-12 04:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.CharField(max_length=200)),
                ('task_status', models.CharField(choices=[('Incomplete', 'incomplete'), ('Not yet started', 'not yet started'), ('Completed', 'complete')], max_length=20)),
